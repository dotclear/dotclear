...
class Manage
{
    ...
    public static function process(): bool
    {
        ...
        if (is_array(My::settings()->get('widgets_nav'))) {
            self::$widgets_nav = WidgetsStack::load(My::settings()->get('widgets_nav'));
        }

        if (is_array(My::settings()->get('widgets_extra'))) {
            self::$widgets_extra = WidgetsStack::load(My::settings()->get('widgets_extra'));
        }

        if (is_array(My::settings()->get('widgets_custom'))) {
            self::$widgets_custom = WidgetsStack::load(My::settings()->get('widgets_custom'));
        }
