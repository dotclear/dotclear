...
$__widgets->create('navigation', __('Navigation links'), ['defaultWidgets', 'navigation'], null, 'List of navigation links');
...
$__widgets->create('bestof', __('Selected entries'), ['defaultWidgets', 'bestof'], null, 'List of selected entries');
$__widgets->bestof->setting('title', __('Title (optional)') . ' :', __('Best of me'));
$__widgets->bestof->setting('orderby', __('Sort:'), 'asc', 'combo', [__('Ascending') => 'asc', __('Descending') => 'desc']);
...
$__widgets->create('langs', __('Blog languages'), ['defaultWidgets', 'langs'], null, 'List of available languages');
...
$__widgets->create('categories', __('List of categories'), ['defaultWidgets', 'categories'], null, 'List of categories');
...
$__widgets->create('subscribe', __('Subscribe links'), ['defaultWidgets', 'subscribe'], null, 'Feed subscription links (RSS or Atom)');
$__widgets->subscribe->setting('title', __('Title (optional)') . ' :', __('Subscribe'));
$__widgets->subscribe->setting('type', __('Feeds type:'), 'atom', 'combo', ['Atom' => 'atom', 'RSS' => 'rss2']);
...
$__widgets->create('feed', __('Feed reader'), ['defaultWidgets', 'feed'], null, 'List of last entries from feed (RSS or Atom)');
...
$__widgets->create('text', __('Text'), ['defaultWidgets', 'text'], null, 'Simple text');
...
$__widgets->create('lastposts', __('Last entries'), ['defaultWidgets', 'lastposts'], null, 'List of last entries published');
...
$__widgets->create('lastcomments', __('Last comments'), ['defaultWidgets', 'lastcomments'], null, 'List of last comments published');
