  ...
  <div class="fieldset">
    ...
    <p>
      <label class="classic" for="dcckeditor_active">
        <?php echo form::checkbox('dcckeditor_active', 1, dcCore::app()->admin->editor_cke_active); ?>
        <?php echo __('Enable dcCKEditor plugin'); ?>
      </label>
    </p>
  </div>
  <?php if (dcCore::app()->admin->editor_cke_active): ?>
  <div class="fieldset">
    <h3>
      <?php echo __('Options'); ?>
    </h3>
    <p>
      <?php echo form::checkbox('dcckeditor_alignment_buttons', 1, dcCore::app()->admin->editor_cke_alignment_buttons); ?>
      <label class="classic" for="dcckeditor_alignment_buttons">
        <?php echo __('Add alignment buttons'); ?>
      </label>
    </p>
    <p>
      <?php echo form::checkbox('dcckeditor_list_buttons', 1, dcCore::app()->admin->editor_cke_list_buttons); ?>
      <label class="classic" for="dcckeditor_list_buttons">
        <?php echo __('Add lists buttons'); ?>
      </label>
    </p>
    <p>
      <?php echo form::checkbox('dcckeditor_textcolor_button', 1, dcCore::app()->admin->editor_cke_textcolor_button); ?>
      <label class="classic" for="dcckeditor_textcolor_button">
        <?php echo __('Add text color button'); ?>
      </label>
    </p>
    <p>
      <?php echo form::checkbox('dcckeditor_background_textcolor_button', 1, dcCore::app()->admin->editor_cke_background_textcolor_button); ?>
    ...
    <p class="field">
      ...
      <?php echo form::number('dcckeditor_colors_per_row', ['min' => 4, 'max' => 16, 'default' => dcCore::app()->admin->editor_cke_colors_per_row]); ?>
    </p>
    <p class="clear form-note">
      <?php echo __('Valid range: 4 to 16'); ?>
    </p>
    <p>
      <?php echo form::checkbox('dcckeditor_cancollapse_button', 1, dcCore::app()->admin->editor_cke_cancollapse_button); ?>
      <label class="classic" for="dcckeditor_cancollapse_button">
        <?php echo __('Add collapse button'); ?>
      </label>
    </p>
    <p>
      <?php echo form::checkbox('dcckeditor_format_select', 1, dcCore::app()->admin->editor_cke_format_select); ?>
    ...
    <p>
      ...
      <?php echo form::field('dcckeditor_format_tags', 100, 255, dcCore::app()->admin->editor_cke_format_tags); ?>
    </p>
    <p class="clear form-note">
      <?php echo __('Default formats are p;h1;h2;h3;h4;h5;h6;pre;address'); ?>
    </p>
    <p>
      <?php echo form::checkbox('dcckeditor_table_button', 1, dcCore::app()->admin->editor_cke_table_button); ?>
      <label class="classic" for="dcckeditor_table_button">
        <?php echo __('Add table button'); ?>
      </label>
    </p>
    <p>
      <?php echo form::checkbox('dcckeditor_clipboard_buttons', 1, dcCore::app()->admin->editor_cke_clipboard_buttons); ?>
    ...
    <p>
      <?php echo form::checkbox('dcckeditor_action_buttons', 1, dcCore::app()->admin->editor_cke_action_buttons); ?>
      <label class="classic" for="dcckeditor_action_buttons">
        <?php echo __('Add undo/redo buttons'); ?>
      </label>
    </p>
    <p>
      <?php echo form::checkbox('dcckeditor_disable_native_spellchecker', 1, dcCore::app()->admin->editor_cke_disable_native_spellchecker); ?>
...
<?php endif;?>
<?php \Dotclear\Core\Backend\Page::helpBlock('dcCKEditor');?>
