...
Clearbricks::lib()->autoload([
    ...
    'dcPostsActionsPageV2'    => __DIR__ . '/admin/actions/class.dcactionposts.php',
    'dcCommentsActionsPageV2' => __DIR__ . '/admin/actions/class.dcactioncomments.php',
    'dcBlogsActionsPageV2'    => __DIR__ . '/admin/actions/class.dcactionblogs.php',
    'dcActionsPageV2'         => __DIR__ . '/admin/actions/class.dcaction.php',
