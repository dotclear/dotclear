...
$__autoload['dcPostsActionSet']			= dirname(__FILE__).'/admin/actions/class.dcactionposts.php';
$__autoload['dcActionSet']			= dirname(__FILE__).'/admin/actions/class.dcaction.php';
