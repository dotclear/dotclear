...
Clearbricks::lib()->autoload([
    ...
    'adminGenericList'      => __DIR__ . '/admin/lib.pager.php',
    ...
    'adminGenericFilter'    => __DIR__ . '/admin/lib.adminfilters.php',
    ...
    'dcPostsActionsPage'    => __DIR__ . '/admin/actions/class.dcactionposts.php',
    'dcCommentsActionsPage' => __DIR__ . '/admin/actions/class.dcactioncomments.php',
    'dcBlogsActionsPage'    => __DIR__ . '/admin/actions/class.dcactionblogs.php',
    'dcActionsPage'         => __DIR__ . '/admin/actions/class.dcaction.php',
