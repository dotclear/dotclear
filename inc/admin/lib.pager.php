...
class adminMediaList extends adminGenericList
{
    ...
    public static function mediaLine(dcCore $core, $filters, $f, $i, $query = false, $page_adminurl = 'admin.media')
    {
        ...
        if ($filters->file_mode != 'list') {
            ...
            '<img class="media-icon-square' . ($f->media_preview ? ' media-icon-preview' : '') . '" src="' . $f->media_icon . '" alt="" />' . ($query ? $file : $fname) . '</a></p>';
            ...
            '<img class="media-icon-square' . ($f->media_preview ? ' media-icon-preview' : '') . '" src="' . $f->media_icon . '" alt="" />' . ($query ? $file : $fname) . '</a>' .
