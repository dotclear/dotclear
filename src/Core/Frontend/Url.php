            ...
            if (App::frontend()->context()->posts->isEmpty()) {
                ...
                if ($post_comment) {
                    ...
                    if ($preview) {
                        ...
                        $cur->comment_status  = App::status()->comment()->level(App::blog()->settings()->system->comments_pub ? 'published' : 'unpublished');
                        ...
                        try {
                            ...
                            $redir_arg = $cur->comment_status >= App::status()->comment()->level('published') ? 'pub=1' : 'pub=0';
