...
class User extends Process
{
    public static function init(): bool
    {
        ...
        dcCore::app()->admin->user_options = Core::users()->userDefaults();
        ...
        if (!empty($_REQUEST['id'])) {
            try {
                dcCore::app()->admin->rs = Core::users()->getUser($_REQUEST['id']);
        ...
        if (isset($_POST['user_name'])) {
            ...
            try {
                ...
                if (dcCore::app()->admin->user_id) {
                    ...
                    $new_id = Core::users()->updUser(dcCore::app()->admin->user_id, $cur);
    ...
    public static function render(): void
    {
        ...
        if (dcCore::app()->admin->user_id) {
            ...
            if (!dcCore::app()->admin->user_super) {
                ...
                $permissions = Core::users()->getUserPermissions(dcCore::app()->admin->user_id);
