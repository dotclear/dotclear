                    ...
                    ->items([
                        ...
                        (new Ul())
                            ->items([
                                ...
                                (new Li())
                                    ->text(__('“Blog”: indicates that plugin has a specific settings in blog parameters, usually used to add or modify some comportements or aspects of the public blog.')),
                                (new Li())
                                ...
                                (new Li())
                                    ->text(__('“Other”: indicates that plugin has a specific settings in other context.')),
                                (new Li())
