...
/**
 * @brief   WebAuthn attestation format option for u2f (FIDO) format.
 *
 * @author  Jean-Christian Paul Denis
 * @since   2.36
 */
class U2f extends FormatBase implements FormatU2fInterface
{
    private int $_alg = -7;
    ...
    public function validateAttestation(string $clientDataHash): bool
    {
        ...
        $dataToVerify = "\x00";
        $dataToVerify .= $this->authenticator->getRpIdHash();
        $dataToVerify .= $clientDataHash;
        $dataToVerify .= $this->authenticator->getCredentialId();
        $dataToVerify .= $this->authenticator->getPublicKeyU2F();
