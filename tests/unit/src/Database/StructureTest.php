...
class StructureTest extends TestCase
{
    ...
    public function testSynchronizeWithModifications(string $driver, string $driver_folder, string $syntax, string $schema_folder, array $data, array $info, array $sql, array $sql_bis): void
    {
        if ($syntax === 'sqlite') {
            ...
            // Fields
            // Add a new field
            $table->field('extra', 'TEXT', 0, true, null);
            // Modify an existing field
            $table->field('fullname', 'TEXT', 0, true, null);
    ...
    public static function dataProviderTestSynchronize(): array
    {
        $data = [
            ...
            'fields' => [
                ...
                ['uid', 'BIGINT', 0, true, null],
                ['cost', 'FLOAT', 0, true, null],
                ['discount', 'REAL', 0, true, null],
                ['number', 'NUMERIC', 0, true, null],
                ['date', 'DATE', 0, true, null],
                ['hour', 'TIME', 0, true, null],
                ['ts', 'TIMESTAMP', 0, true, 'now()'],
                ['name', 'CHAR', 255, true, null],
                ['fullname', 'VARCHAR', 0, true, null],
...
extra text NULL DEFAULT NULL
            ...
            ['pdosqlite', 'PdoQqlite', 'sqlite', 'PdoSqlite', $data, $info,
                [
                    // Init
                    'CREATE TABLE dc_dc_table (id integer NOT NULL DEFAULT 0, status integer NULL DEFAULT -1, uid integer NULL DEFAULT NULL, cost float NULL DEFAULT NULL, discount real NULL DEFAULT NULL, number numeric NULL DEFAULT NULL, date timestamp NULL DEFAULT NULL, hour timestamp NULL DEFAULT NULL, ts timestamp NULL DEFAULT \'1970-01-01 00:00:00\', name char(255) NULL DEFAULT NULL, fullname varchar NULL DEFAULT NULL, description text NULL DEFAULT NULL, CONSTRAINT dc_pk_id PRIMARY KEY (id), CONSTRAINT dc_uk_uid UNIQUE (id,uid))',
